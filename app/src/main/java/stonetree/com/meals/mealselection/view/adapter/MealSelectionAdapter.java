...
public class MealSelectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MealSelectionAdapter(IMealSelectionView view, MealSelectionPresenter presenter, MealSelectionResponse response) {
        this.view = view;
    ...
    private void setListener(final ViewHolder holder, final Meal meal) {
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View selectedCard) {
                Session.getInstance().getCart().setMeal(meal);
                view.proceedToIngredientsSelection();
            }
        });
